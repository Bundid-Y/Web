...
$theme = [
    ...
    "dark" => "#941b22",
    "soft" => "#fff5f5",
    "company" => "Koch Packaging and Packing Services Co., Ltd.",
    "contact" => "ฝ่ายทรัพยากรบุคคล",
    "address" => "18/2 หมู่ 5 ตำบลเหมือง อำเภอเมืองชลบุรี จังหวัดชลบุรี 20130",
    "email" => "salesteam@koch-packaging.com"
];

$jobs = [
    "purchasing-manager" => [
        "title" => "Purchasing Assistant Manager / Manager",
        "type" => "จัดซื้อ / Supply Chain",
        "location" => "อ.เมืองชลบุรี จ.ชลบุรี",
        "salary" => "ตามโครงสร้างบริษัทฯ",
        "vacancy" => "ไม่ระบุ",
        "description" => [
            "วางแผนและบริหารงานจัดซื้อให้สอดคล้องกับความต้องการของฝ่ายผลิตและคลังสินค้า",
            "ประสานงานซัพพลายเออร์ ควบคุมต้นทุน และติดตามกำหนดส่งมอบ",
            "สนับสนุนการจัดทำข้อมูลเพื่อวิเคราะห์ต้นทุนและประสิทธิภาพของ Supply Chain"
        ],
        "qualifications" => [
            "มีประสบการณ์ด้านจัดซื้อหรือ Supply Chain ในธุรกิจอุตสาหกรรม",
            "มีทักษะการเจรจา วิเคราะห์ราคา และบริหารเอกสารจัดซื้อ",
            "สามารถทำงานร่วมกับหลายฝ่ายและติดตามงานได้เป็นระบบ"
        ]
    ],
    "secretary-to-ceo" => [
        "title" => "Secretary to CEO (Executive Strategic Coordinator)",
        "type" => "บริหาร / ประสานงานผู้บริหาร",
        "location" => "จ.ชลบุรี",
        "salary" => "ตามตกลง",
        "vacancy" => "ไม่ระบุ",
        "description" => [
            "ประสานงานตารางนัดหมาย เอกสาร และการสื่อสารระหว่างผู้บริหารกับหน่วยงานที่เกี่ยวข้อง",
            "ติดตามงานเชิงกลยุทธ์และสรุปประเด็นสำคัญเพื่อสนับสนุนการตัดสินใจ",
            "จัดเตรียมรายงาน งานประชุม และเอกสารประกอบการบริหาร"
        ],
        "qualifications" => [
            "มีทักษะการสื่อสารและการจัดลำดับความสำคัญของงานดี",
            "สามารถรักษาความลับและทำงานภายใต้กรอบเวลาที่ชัดเจน",
            "ใช้โปรแกรมสำนักงานและจัดทำรายงานได้คล่อง"
        ]
    ],
    "truck-mechanic" => [
        "title" => "ช่างยนต์ และ ช่างไฟ (รถบรรทุก & รถหัวลาก)",
        "type" => "ช่างเทคนิค / Fleet Maintenance",
        "location" => "อ.ศรีราชา จ.ชลบุรี",
        "salary" => "ตามตกลง",
        "vacancy" => "2 อัตรา",
        "description" => [
            "ตรวจสอบการซ่อมบำรุงรถบรรทุกและรถหัวลาก",
            "ประสานงานการซ่อมตามระยะเวลาและติดตามสถานะงานซ่อม",
            "ควบคุมค่าใช้จ่ายด้านซ่อมบำรุงให้อยู่ในกรอบที่กำหนด"
        ],
        "qualifications" => [
            "เพศชาย อายุ 30-45 ปี",
            "มีประสบการณ์การบำรุงรักษารถ 6W / Trailer",
            "มีความรับผิดชอบ ขยัน และอดทนต่องาน",
            "สามารถรับแรงกดดันและแก้ปัญหาเฉพาะหน้าได้ดี",
            "สามารถเริ่มงานได้ทันทีจะพิจารณาเป็นพิเศษ"
        ]
    ],
    "cost-accounting-supervisor" => [
        "title" => "นักบัญชีและตรวจสอบต้นทุน - Supervisor / Assistant Manager",
        "type" => "บัญชี / ต้นทุน",
        "location" => "อ.เมืองชลบุรี จ.ชลบุรี",
        "salary" => "ตามตกลง",
        "vacancy" => "ไม่ระบุ",
        "description" => [
            "ตรวจสอบต้นทุนการผลิตและต้นทุนการดำเนินงาน",
            "จัดทำรายงาน วิเคราะห์ข้อมูล และเสนอแนวทางควบคุมต้นทุน",
            "ประสานงานกับฝ่ายผลิต คลังสินค้า และบัญชีเพื่อให้ข้อมูลถูกต้อง"
        ],
        "qualifications" => [
            "มีประสบการณ์ด้านบัญชีต้นทุนหรือบัญชีโรงงาน",
            "วิเคราะห์ตัวเลขและใช้โปรแกรมสำนักงานได้ดี",
            "ละเอียดรอบคอบและทำงานตามกำหนดเวลาได้"
        ]
    ],
    "sales-engineer" => [
        "title" => "Sales Engineer - Supply Chain Management",
        "type" => "ขาย / วิศวกรรม",
        "location" => "อ.เมืองชลบุรี จ.ชลบุรี",
        "salary" => "ตามประสบการณ์",
        "vacancy" => "ไม่ระบุ",
        "description" => [
            "นำเสนอโซลูชันด้าน Packaging และ Supply Chain ให้ลูกค้าอุตสาหกรรม",
            "วิเคราะห์ความต้องการลูกค้าและประสานงานทีมเทคนิคเพื่อจัดทำข้อเสนอ",
            "ดูแลความสัมพันธ์ลูกค้าและติดตามโอกาสทางธุรกิจใหม่"
        ],
        "qualifications" => [
            "มีพื้นฐานงานขายเชิงเทคนิคหรือ Supply Chain",
            "สื่อสารและประสานงานกับลูกค้าองค์กรได้ดี",
            "มีความเข้าใจธุรกิจอุตสาหกรรมจะพิจารณาเป็นพิเศษ"
        ]
    ]
];

$jobKey = $_GET["job"] ?? "truck-mechanic";
$job = $jobs[$jobKey] ?? reset($jobs);
?>
<!DOCTYPE html>
<html lang="th">
...
<head>
    ...
    <title><?php echo htmlspecialchars($job["title"]); ?> | Koch Careers</title>
    <meta name="description" content="<?php echo htmlspecialchars($job["title"]); ?> รายละเอียดงาน คุณสมบัติ และช่องทางสมัครงานกับ Koch Packaging and Packing Services" />
        ...
        <div class="detail-wrap detail-grid">
            ...
            <aside class="detail-sidebar">
                <div class="sidebar-block">
                    ...
                    <p class="contact-lines"><?php echo $theme["contact"]; ?><br><?php echo $theme["company"]; ?><br><?php echo $theme["address"]; ?><br>อีเมล: <?php echo $theme["email"]; ?></p>
                </div>
                <div class="sidebar-block">
