...
<head>
    ...
    <title>รายละเอียดตำแหน่งงาน | Koch Careers</title>
    <meta name="description" content="รายละเอียดตำแหน่งงาน คุณสมบัติ และช่องทางสมัครงานกับ Koch Packaging and Packing Services Co., Ltd." />
    ...
    <style>
        ...
        h4.detail-heading { font-size: 20px; }
        ...
        .position-links { display: grid; gap: 8px; margin: 0; padding: 0; list-style: none; }
        .position-links a {
            display: block;
            border: 1px solid #e7eaf0;
            border-radius: 8px;
...
<body class="page-recruitment-detail">
    ...
    <header class="detail-hero">
        <div class="detail-wrap">
            <h1 class="detail-title" id="hero-title">รายละเอียดตำแหน่งงาน</h1>
        </div>
    </header>
    ...
    <main class="detail-main">
        <div class="detail-wrap detail-grid">
            <div>
                <article class="job-detail" id="purchasing-manager" data-title="Purchasing Assistant Manager / Manager">
                ...
                <article class="job-detail" id="secretary-to-ceo" data-title="Secretary to CEO (Executive Strategic Coordinator)">
                    <section class="detail-card">
                        <h2 class="detail-heading">สรุปตำแหน่งงาน</h2>
                        <div class="detail-summary">
                    ...
                    <section class="detail-card">
                        <h2 class="detail-heading">รายละเอียดงาน</h2>
                        <h4 class="detail-heading">หน้าที่ความรับผิดชอบหลัก</h4>
                        <ol class="detail-list">
                            <li>สนับสนุน CEO ในการวางแผนธุรกิจ การพัฒนากลยุทธ์ และการตัดสินใจ</li>
                            <li>จัดเตรียมเอกสารสำหรับผู้บริหาร เช่น แผนธุรกิจ แดชบอร์ด และรายงานวิเคราะห์ต่าง ๆ</li>
                            <li>วิเคราะห์ข้อมูลและนำเสนอข้อเสนอแนะเพื่อช่วยในการตัดสินใจ</li>
                            <li>ติดตามตัวชี้วัดผลงาน หรือ KPI และตรวจสอบผลการดำเนินงานของทุกฝ่าย เช่น ฝ่ายปฏิบัติการ ฝ่ายขาย/การตลาด ฝ่ายการเงิน และฝ่ายทรัพยากรบุคคล</li>
                            <li>ดูแลให้การดำเนินโครงการเชิงกลยุทธ์เป็นไปตามแผน ระยะเวลา และเป้าหมายที่กำหนด</li>
                            <li>ระบุความเสี่ยง ความล่าช้า หรือปัญหาด้านผลการดำเนินงาน พร้อมเสนอแนวทางแก้ไขและรายงานต่อผู้บริหาร</li>
                            <li>ติดตามงานที่ CEO มอบหมาย เพื่อให้มั่นใจว่างานเสร็จสมบูรณ์ตามกำหนด</li>
                            <li>ประสานงานกับผู้อำนวยการแต่ละฝ่าย และดูแลให้ทุกหน่วยงานดำเนินงานสอดคล้องกัน</li>
                            <li>จัดเตรียมวาระการประชุม บันทึกการประชุม และติดตามรายการงานที่ต้องดำเนินการจนกว่าจะเสร็จสิ้น</li>
                            <li>พัฒนาแดชบอร์ดสำหรับติดตามผลการดำเนินงาน และสนับสนุนการตัดสินใจของผู้บริหาร</li>
                            <li>เป็นผู้นำหรือประสานงานโครงการพิเศษ รวมถึงสนับสนุนโครงการขยายธุรกิจของบริษัท</li>
                        </ol><br>
                        <h4 class="detail-heading">ตัวชี้วัดผลงานหลัก (KPIs)</h4>
                            <ol class="detail-list">
                                <li>งานที่ CEO มอบหมายเสร็จตรงเวลาไม่น้อยกว่า 95%</li>
                                <li>ความถูกต้องและคุณภาพของรายงานไม่น้อยกว่า 95%</li>
                                <li>ติดตาม KPI ครอบคลุมทุกแผนก 100%</li>
                                <li>รายงานความเสี่ยงหรือปัญหาที่เกิดขึ้นภายใน 24 ชั่วโมง</li>
                                <li>ประสิทธิภาพในการประสานงานและผลักดันงานร่วมกับหลายฝ่าย</li>
                            </ol>
                    </section>
                    <section class="detail-card">
                        <h2 class="detail-heading">คุณสมบัติผู้สมัคร</h2>
                        <ol class="detail-list">
                            ...
                            <li>มีประสบการณ์ด้านการวางแผนธุรกิจ และการทำงานร่วมกับผู้บริหารระดับสูง</li>
                            <li>สามารถเดินทางไปต่างประเทศได้บ่อย</li>
                            <li>มีความยืดหยุ่นสูง คล่องตัว และสามารถทำงานภายใต้ความกดดันได้ดี</li>
                        </ol>
                    </section>
                </article>
    ...
    <script>
        (function () {
            ...
            const selectedJob = params.get('job') || 'truck-mechanic';
            const jobs = document.querySelectorAll('.job-detail');
            const links = document.querySelectorAll('.position-links a');
            const selectedPanel = document.getElementById(selectedJob) || document.getElementById('truck-mechanic');
            ...
            links.forEach((link) => {
                const isActive = link.dataset.target === selectedPanel.id;
