            ...
            <section class="content-panel">
                <div class="detail-panel is-active" id="truck-driver" data-title="พนักงานขับรถบรรทุก / รถหัวลาก">
                    ...
                    <div class="detail-section">
                        ...
                        <ol class="detail-list">
                            <li>ต้องมีใบอนุญาตขับรถประเภท ท.2/ ท.3/ ท.4 </li>
                            <li>สามารถขับรถบรรทุก รถหัวลาก รถพ่วง หรือรถกึ่งพ่วงได้</li>
                            <li>มีประสบการณ์ด้านงานขนส่งสินค้า จะพิจารณาเป็นพิเศษ</li>
                            <li>สามารถตรวจเช็กสภาพรถเบื้องต้นก่อนออกปฏิบัติงานได้</li>
                            <li>ปฏิบัติตามกฎจราจรและระเบียบความปลอดภัยของบริษัทอย่างเคร่งครัด</li>
