...
<!-- Footer Component — TNB Logistics -->
<footer class="footer-custom">
    <div class="footer-container">
        <!-- Column 1: Brand & Contact -->
        <div class="footer-col footer-brand">
            <h3 class="footer-logo">TNB Logistics</h3>
            <p class="footer-desc" data-i18n="footer.desc">RELIABLE, STABLE and SOLUTION
            ...
            <ul class="footer-contact">
                ...
                <li style="margin-top: 15px; font-weight: bold;">
                    Container Truck Management (Import&Export)
                </li>
                <li>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <span>090-9542354 <span data-i18n="contact.name_o">(คุณโอ)</span></span>
                </li>
                <li>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round">
                ...
                <li style="margin-top: 15px; font-weight: bold;">
                    Domestic Truck Management (Milkrun&Nationwide Distribution)
                </li>
                <li>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <span>085-8799795 <span data-i18n="contact.name_tle">(คุณเติ้ล)</span></span>
                </li>
                <li>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <span>alisa.j@tnb-logistics.com</span>
                </li>
            </ul>
        </div>
